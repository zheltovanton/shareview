...
begin
  ShellExecute (0,'open', pchar('http://miridixsoft.com/'), pchar(''),nil, SW_show);
end;

procedure Tfoabout.Label4Click(Sender: TObject);
begin
  ShellExecute (0,'open', pchar('http://miridixsoft.com/files/shareview_setup.exe'), pchar(''),nil, SW_show);
end;
...
begin
  ShellExecute (0,'open', pchar('http://miridixsoft.com/page-3.htm'), pchar(''),nil, SW_show);
